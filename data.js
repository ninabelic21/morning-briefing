window.BRIEFING = {
  ...
  watchlist: {
    ...
    periods: {
      daily: {
        chart: [
          { label: "WMT", change: "+0.58%", width: "25%", showLabel: false },
          { label: "MSFT", change: "+0.25%", width: "12%", showLabel: false },
          { label: "ETF146", change: "\u22120.38%", width: "18%", showLabel: false },
          { label: "NVDA", change: "\u22120.44%", width: "22%", showLabel: false },
          { label: "MPWR", change: "\u22120.49%", width: "25%", showLabel: false },
          { label: "A0RPWJ", change: "\u22121.12%", width: "56%", showLabel: false },
          { label: "LLY", change: "\u22121.98%", width: "79%", showLabel: false }
        ],
        items: [
      ...
      weekly: {
        chart: [
          { label: "WMT", change: "+3.2%", width: "62%", showLabel: false },
          { label: "MSFT", change: "+2.1%", width: "50%", showLabel: false },
          { label: "NVDA", change: "+1.8%", width: "44%", showLabel: false },
          { label: "MPWR", change: "+0.9%", width: "27%", showLabel: false },
          { label: "ETF146", change: "\u22120.2%", width: "6%", showLabel: false },
          { label: "A0RPWJ", change: "\u22121.5%", width: "45%", showLabel: false },
          { label: "LLY", change: "\u22123.1%", width: "93%", showLabel: false }
        ],
        items: [
      ...
      monthly: {
        chart: [
          { label: "NVDA", change: "+8.4%", width: "42%", showLabel: false },
          { label: "MPWR", change: "+5.2%", width: "26%", showLabel: false },
          { label: "MSFT", change: "+4.1%", width: "20.5%", showLabel: false },
          { label: "WMT", change: "+2.8%", width: "14%", showLabel: false },
          { label: "ETF146", change: "+1.2%", width: "6%", showLabel: false },
          { label: "A0RPWJ", change: "\u22120.8%", width: "4%", showLabel: false },
          { label: "LLY", change: "\u22125.6%", width: "28%", showLabel: false }
        ],
        items: [
      ...
      threeMonth: {
        chart: [
          { label: "NVDA", change: "+14.2%", width: "71%", showLabel: false },
          { label: "MPWR", change: "+9.8%", width: "49%", showLabel: false },
          { label: "MSFT", change: "+7.3%", width: "36.5%", showLabel: false },
          { label: "WMT", change: "+6.1%", width: "30.5%", showLabel: false },
          { label: "A0RPWJ", change: "+3.4%", width: "17%", showLabel: false },
          { label: "ETF146", change: "+2.9%", width: "14.5%", showLabel: false },
          { label: "LLY", change: "\u22122.1%", width: "10.5%", showLabel: false }
        ],
        items: [
  ...
  spotlight: {
    ...
    charts: [
      ...
      },
      {
        ...
        type: "bar",
        bars: [
          { label: "Vietnam", width: "92%", fillClass: "tariff-fill" },
          { label: "China", width: "68%", fillClass: "tariff-fill" },
          { label: "India", width: "52%", fillClass: "tariff-fill" },
          { label: "Japan", width: "48%", fillClass: "tariff-fill" },
          { label: "EU", width: "40%", fillClass: "tariff-fill" }
        ]
      },
      {
        ...
        type: "comparison",
        bars: [
          { label: "Apr \u201925", usHeight: "24px", globalHeight: "32px" },
          { label: "Jul \u201925", usHeight: "18px", globalHeight: "38px" },
          { label: "Oct \u201925", usHeight: "42px", globalHeight: "52px" },
          { label: "Jan \u201926", usHeight: "56px", globalHeight: "70px" },
          { label: "Apr \u201926", usHeight: "70px", globalHeight: "90px" }
        ]
      }
    ],
    legend: [
